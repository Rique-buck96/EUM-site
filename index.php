...
if(isset($_POST['email'])) {
    ...
    $contact_name = $_POST['contact']; // required
  ...
  if(!preg_match($string_exp,$contact_name)) {
    ...
    if(!preg_match($string_exp,$telephone)) {
        $error_message .= 'The Telephone number you have entered is not valid.<br />';
    }
    if(strlen($email_subject) < 2) {
        $error_message .= 'The subject of your enquiry does not appear to be valid.<br />';
    }
